...
const maskingTypes = {
  full: { label: "Full Mask", description: "Replace all characters with *", icon: EyeOff },
  partial: { label: "Partial Mask", description: "Show first/last N characters", icon: Eye },
  hash: { label: "Hash (SHA-256)", description: "One-way cryptographic hash", icon: Shield },
  encrypt: { label: "AES Encryption", description: "Reversible encryption", icon: Shield },
  tokenize: { label: "Tokenization", description: "Replace with random token", icon: Shield },
  redact: { label: "Redact", description: "Remove entirely", icon: EyeOff },
};

const piiTypes = [
  "ssn", "credit_card", "email", "phone", "address", "name", 
  "dob", "ip_address", "custom"
];
