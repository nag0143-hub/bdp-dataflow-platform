...
- **Landing Page**: LDAPIntegration page is the main/landing page (`mainPage: "LDAPIntegration"` in pages.config.js). Shows DataFlow branding (#0060AF blue Workflow icon), app description, "Preferred ID" + password form. Demo credentials banner only in dev mode. Post-login shows user info, role, and domain cards.
