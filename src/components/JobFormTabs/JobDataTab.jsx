...
const FILE_INPUT_MODES = [
  { value: "file_list", label: "File List", icon: FileText, desc: "Provide specific file names" },
  { value: "folder", label: "Folder Path", icon: FolderSearch, desc: "All files from a directory" },
  { value: "wildcard", label: "Wildcard Pattern", icon: Asterisk, desc: "Match files using glob patterns" },
];
...
const SCHEMA_IMPORT_MODES = [
  { value: "csv", label: "CSV Schema", icon: FileSpreadsheet, desc: "CSV header or column definitions" },
  { value: "json", label: "JSON Schema", icon: FileJson, desc: "JSON column definitions" },
  { value: "cfd", label: "CFD / Copybook", icon: FileCode, desc: "COBOL copybook with PIC clauses" },
];
